...
(defun ning/sync ()
  ...
  (save-excursion
    ...
    (make-process
     :name "ning/sync"
     :buffer "*unison*"
     :command `("unison" "-batch" "-ignore" "Name {.notdeft-db}" ,(expand-file-name "~/roamdb") "ssh://meowmeow//home/admin/roamdb")
...
(defun ning/sync-synchronous ()
  ...
  (let ((coding-system-for-read 'undecided-mac))
    (call-process "unison" nil "*unison*" t "-ignore" "Name {.notdeft-db}" "-batch" (expand-file-name "~/roamdb") "ssh://meowmeow//home/admin/roamdb")))
#+end_src
