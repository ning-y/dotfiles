...
#+begin_src emacs-lisp
(defun ning/push ()
  "Copy the ~/org directory to Google Drive via rclone."
  (interactive)
  (async-shell-command "rclone copy --progress ~/org remote:org"))
(defun ning/pull ()
  "Copy the ~/org directory from Google Drive via rclone."
  (interactive)
  (async-shell-command "rclone copy --progress remote:org ~/org"))
(defun ning/force-push ()
  "Mirror the ~/org directory to Google Drive via rclone."
  (interactive)
  (async-shell-command "rclone sync --progress ~/org remote:org"))
(defun ning/force-pull ()
  "Mirror the ~/org directory from Google Drive via rclone."
  (interactive)
