...
(use-package! org-roam
  ...
  (setq org-roam-directory (file-truename "~/org/roam")
        ...
        org-roam-capture-templates '(("n" "note" plain "%?" :target
                                      ...
                                      :unnarrowed t :immediate-finish t :no-save t)
                                     ("t" "task" plain "%?" :target
...
(use-package! ivy-bibtex
  ...
  (setq bibtex-completion-bibliography '("~/org/files/references.bib")
        ...
        ivy-bibtex-default-multi-action 'ivy-bibtex-insert-key))
...
Here, I use org-roam-bibtex to interface between org-roam notes and org-ref entries.
I use org-ref-insert-link over orb-insert-link.

*TODO:* I can't get org-ref-open-bibtex-notes to work.
