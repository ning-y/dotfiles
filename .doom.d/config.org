...
(setq org-crypt-key "ningyuan.sg@gmail.com")
#+end_src
...
(defun ning/sync ()
  ...
  (save-excursion
    ...
    (make-process
     :name "ning/sync"
     :buffer "*unison*"
     :command `("unison" "-batch" ,(expand-file-name "~/roamdb") "ssh://roamdb-ctl//mnt/roamdb")
...
(defun ning/sync-synchronous ()
  ...
  (let ((coding-system-for-read 'undecided-mac))
    (call-process "unison" nil "*unison*" t "-batch" (expand-file-name "~/roamdb") "ssh://roamdb-ctl//mnt/roamdb")))
#+end_src
